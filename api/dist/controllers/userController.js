...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, fullName, email, password, role, contactNumber, dateOfBirth, isActive, notificationPreferences, existingUser, hashedPassword, newUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, fullName = _req$body.fullName, email = _req$body.email, password = _req$body.password, role = _req$body.role, contactNumber = _req$body.contactNumber, dateOfBirth = _req$body.dateOfBirth, isActive = _req$body.isActive, notificationPreferences = _req$body.notificationPreferences; // Check if the user already exists with the provided email
          _context.next = 4;
...
var uploadProfilePicture = upload.single("profileImage"); // 'profileImage' is the name attribute in the file input field

var updateProfilePictureById = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          userId = req.params.id; // Check if the user exists with the provided ID
          _context2.next = 4;
  ...
  return function updateProfilePictureById(_x3, _x4) {
  ...
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          _req$body2 = req.body, email = _req$body2.email, password = _req$body2.password; // Check if the user exists with the provided email
          _context7.next = 4;
          return _User["default"].findOne({
            email: email
          });
        ...
        case 9:
          isPasswordMatch = _context7.sent;
          if (isPasswordMatch) {
            _context7.next = 12;
            break;
          }
...
var _default = {
  ...
  updateProfilePictureById: updateProfilePictureById,
